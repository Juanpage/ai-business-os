  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm rounded-xl bg-white p-8 shadow-sm ring-1 ring-gray-200">
        <h1 className="text-xl font-semibold text-gray-900">AI Business OS</h1>
        ...
        <p className="mt-4 text-center text-xs text-gray-400">Demo: owner@demo.com / demo1234</p>
      </div>
    </main>
  );
}
